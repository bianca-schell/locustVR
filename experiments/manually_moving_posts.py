    ...
    def run_forever(self):
        ...
        try:
            while 1:
                ...
                for k in range(0,10):
                    #print('k=', k)
                    self.move_node('Cylinder1' , 1, 1,  0)
                    self.move_node('Cylinder2' , 2, 2,  0)
                    self.move_node('Cylinder3' , 1.5, 1.5,  0)
                    self.move_node('Cylinder4' , 10, 1,  0)
                    self.move_node('Cylinder5' , -1.5, -1.5,  0)
                    self.move_node('Cylinder6' , 1.5,-1.5,  0)
                    self.move_node('Cylinder0' , -1.5, 1.5,  0)
                    self.move_node('Cylinder7' , -10000,10000, 1000)
                    self.move_node('Cylinder8' , -10000,10000, 1000)
                    self.move_node('Cylinder9' , -10000,10000, 1000)

...
expDB = '/home/loopbio/Documents/locustVR/databases/locustExperiments_2post_2m_deg30_45_60.db'
                ...
                if t>0.5*60:
                    ...
                    for nPost in range(0,3):
                        ...
                        if reached==True:
                            ...
                            self.move_node('Cylinder1' , 1000, 1000,  0)
                            self.move_node('Cylinder0' , 1000, 1000,  0)
                            time.sleep(8)
                        ...
                        if distance(self.locPosition, self.postPosition[0,:] ,  True) > (0.1+self.postDistance) and distance(self.locPosition, self.postPosition[1,:] ,  True)> (0.1+self.postDistance) and dist < 900:
                            ...
                            print('Locust has reached a distance of > ', 0.1+self.postDistance)
                            print('************************************************************************')
                            print(' ')
                            self.counter += 1
                            reached=True

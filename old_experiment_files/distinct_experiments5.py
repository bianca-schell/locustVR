        ...
        with open(path+'/results.csv', 'a') as output:
            ...
            while nStimuli<=4:
                ...
                '''if t < 1.5:
                    ...
                    pass'''
                if t<0.5:
                #if t >= 1 and t < 1.3 and self.cntr%100000==0:
                    #self.reset_origin()
                    print('position',self.locPosition['x'],self.locPosition['y'], 'time', t)
                    #self.resetting=True
                    #print(self.resetting)
                '''if t >= 1.3:
                    self.resetting=False
                ...
                if t > 2:
                    ...
                    '''for nPost in range(0,10):
                        ...
                        if dist < 0.5:
                            ...
                            # identical: print('xy coord',self.locPosition['x'],gy)                           
                            print('xy global coord',self.locPosition['x'],gy)
                            self.counter+=1
                            nStimuli = nStimuli+1
